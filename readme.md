...
**第 1 步**：访问 [小红书作品批量下载技能官网](https://www.guaikei.com) 开通 TOKEN（数据 API 服务，开通即用）
...
**Q：数据从哪来，合规吗？**
数据经 [小红书笔记研究SKILL](https://www.guaikei.com) 官方数据接口返回，仅覆盖小红书**公开可见**内容。除关键词/链接等查询参数外，不上传本机任何数据。结果限个人/团队内部分析使用。
...
- TOKEN 开通 / 使用帮助：[小红书笔记内容研究技能](https://www.guaikei.com)
